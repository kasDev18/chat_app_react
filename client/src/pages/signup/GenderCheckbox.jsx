  ...
  return (
    <div className="flex">
      <div className="form-control mr-3">
        <label htmlFor="gender_male" className={`label gap-2 cursor-pointer ${selectedGender === "male" ? "selected" : ""} text-xs lg:text-sm`}>
      ...
      <div className="form-control">
        <label htmlFor="gender_female" className={`label gap-2 cursor-pointer ${selectedGender === "female" ? "selected" : ""} text-xs lg:text-sm`}>
